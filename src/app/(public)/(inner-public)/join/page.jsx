    ...
    <main className="min-h-screen w-full mx-auto">
      <section className="pb-16 pt-14 text-center flex flex-col items-center">
        <div className="md:flex items-center mb-5 hidden">
          ...
          <div className="flex flex-col items-start border-s ps-4 ms-3">
            <h2 className="uppercase font-semibold -tracking-wider">Sabuag</h2>
        ...
        {data && data.length > 0 && (
          <>
            ...
            <p className="text-sm md:text-xl max-w-3xl mx-auto">
              If you're into writing, design, photography, or a former campus
              journalist, <br /> we’ve got a spot for you.
            </p>

            <div className="flex items-center gap-2 mt-6">
              <Button size="sm" asChild>
                <Link href="mailto:sabuag@gmail.edu.ph">Send an Email</Link>
              </Button>
        ...
        {data.length === 0 && (
          <div className="pb-16 flex flex-col items-center">
            ...
            <p className="text-neutral-400 text-center mb-8">
              Thank you for your interest in joining our publication! <br /> Our
              team is currently complete for this semester, but we’d love to
              keep in touch.
            </p>
      ...
      <section className="py-20 mx-auto text-center border-t-0 md:border-t dark:border-neutral-800 mt-12 md:mt-20">
        ...
        <p className="text-neutral-700 dark:text-neutral-400 text-lg">
          Joining us isn’t just about publishing stories — it’s about finding
          your people, discovering your voice, and building memories that last.
          Here’s what’s in store when you become part of the team.
        </p>
      </section>
      ...
      <section className="pb-12">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 text-center">
          <div>
            <User className="mx-auto dark:text-neutral-400" size={40} />
            <h3 className="text-xl font-medium mt-4">Expand your Voice</h3>

            <p className="text-neutral-600 italic text-sm dark:text-neutral-400/80 mt-2">
              Cover campus events, create print or digital stories, and see your
              work published and celebrated.
            </p>
          </div>
          <div>
            <User className="mx-auto dark:text-neutral-400" size={40} />
            <h3 className="text-xl font-medium mt-4">Bond with the Team</h3>
            <p className="text-neutral-600 italic text-sm dark:text-neutral-400/80 mt-2">
              We’re not just a publication — we’re a family. From bonding nights
              to outreach programs, we grow together.
            </p>
          </div>
          <div>
            <User className="mx-auto dark:text-neutral-400" size={40} />
            <h3 className="text-xl font-medium mt-4">Boost your Confidence</h3>
            <p className="text-neutral-600 italic text-sm dark:text-neutral-400/80 mt-2">
              Take part in seminars that improve not just your craft, but your
              leadership, communication, and confidence.
            </p>
          </div>
          <div>
            <BookOpen className="mx-auto dark:text-neutral-400" size={40} />
            <h3 className="text-xl font-medium mt-4">Skill Development</h3>
            <p className="text-neutral-600 italic text-sm dark:text-neutral-400/80 mt-2">
