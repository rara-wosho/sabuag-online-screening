...
export default function FeedbackCard({ feedbackData }) {
  ...
  return (
    <div className="flex flex-col items-start gap-2 bg-card rounded-lg p-4 h-full border dark:border-neutral-800">
      <div className="flex items-start gap-2">
        ...
        <div>
          <p className="tracking-wide">{feedbackData.feedback_author}</p>
      ...
      <div className="relative">
        <div className="flex items-center gap-2 mb-4 text-neutral-300 dark:text-neutral-700">
          <div
            className={cn(feedbackData.rate == "1" && "text-accent-foreground")}
          >
            <Laugh size={18} />
          </div>

          <div
            className={cn(feedbackData.rate == "2" && "text-accent-foreground")}
          >
            <Smile size={18} />
          </div>

          <div
            className={cn(feedbackData.rate == "3" && "text-accent-foreground")}
          >
            <Meh size={18} />
          </div>
          <div
            className={cn(feedbackData.rate == "4" && "text-accent-foreground")}
          >
            <Frown size={18} />
          </div>
        </div>
