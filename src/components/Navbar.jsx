...
export default function Navbar({ currentUser }) {
    return (
        <div className="flex items-center justify-center border-b border-b-neutral-200 dark:border-neutral-800 fixed top-0 left-0 w-full backdrop-blur-xl  bg-background/30 px-3 z-50">
