...
export default function InviteSection() {
    return (
        <div className="w-full max-w-[97%] mx-auto  flex flex-col items-center justify-center py-12 rounded-lg px-3 mb-[6rem]">
            <h1 className="text-4xl font-semibold mb-3 text-center">
                Want To Be Part of the{" "}
                <span className="text-accent-foreground">Team?</span>
            </h1>

            <p className="dark:text-slate-300/80 text-center max-w-3xl">
